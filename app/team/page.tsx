  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: "Create Profile", href: "/job-seekers/login" },
        { name: "Resume Builder", href: "/job-seekers/login" },
        { name: "Career Advice", href: "/learn-more" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Browse Candidates", href: "/employers/login" },
        { name: "Employer Dashboard", href: "/employers/login" },
        { name: "Pricing Plans", href: "/employers/login" },
